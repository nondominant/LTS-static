...
<div className={!scroll 
  ...
  <div className={[style.header_image, style.logo_pos].join(" ")}>
    <Image className={style.image} alt="transparent Laundtry Tech Solutions logo" src={transparent_logo} layout='fill'/></div>
    <div>
      <input type="radio" name="menu" id="check01" />
      <label htmlFor="check01">Menu</label>
      <ul className={style.submenu}>
<li><Link href="/"><a>Home</a></Link></li>
<li><Link href="/about"><a>Home</a></Link></li>
    ...
    <div>
      ...
      <label htmlFor="check011">Menu</label>
      <ul className={style.submenu}>
        <li><a href="#">Item 1</a></li>
        <li><a href="#">Item 2</a></li>
        <input type="radio" name="menu" id="close" />
    ...
    <div>
      ...
      <label htmlFor="check012">Menu</label>
      <ul className={style.submenu}>
        <li><a href="#">Item 1</a></li>
        <li><a href="#">Item 2</a></li>
        <input type="radio" name="menu" id="close" />
    ...
    <div>
      ...
      <label htmlFor="check02">Menu</label>
      <ul className={style.submenu}>
        <li>
          ...
          <div className={[style.naviGAYtion, style.column].join(" ")}>
            <div>
              ...
              <label htmlFor="check04">Menu</label>
            ...
            <div>
              ...
              <label htmlFor="check05">Menu</label>
              <ul className={style.subsubmenu}>
                <li><a href="#">Item 1</a></li>
                <li><a href="#">Item 2</a></li>
              </ul>
            ...
            <div>
              ...
              <label htmlFor="check06">Menu</label>
              <ul className={style.subsubmenu}>
                <li><a href="#">Item 1</a></li>
                <li><a href="#">Item 2</a></li>
              </ul>
    ...
    <div>
      ...
      <label htmlFor="check03">Menu</label>
      <ul className={style.submenu}>
        <li><a href="#">Item 1</a></li>
        <li><a href="#">Item 2</a></li>
