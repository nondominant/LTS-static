...
const ContentPanel = (props) => (
  <div id={props.id} className={style.panel}>
    <Article 
      ...
      textRight="We offer solutions for laundry and rail system design, project management, software solutions, maintenance management systems, and Decommisioning/commissioning plant or machinery"
    />
  </div>
);
